    ...
    <main className="min-h-screen bg-white text-slate-900 p-8">
      ...
      >
        ...
        <textarea
          ...
          className="w-full rounded border p-3 h-28"
        />

        <button className="rounded-2xl px-6 py-3 font-semibold shadow ring-1 ring-slate-900/10">
          Submit
        </button>
      </form>
      ...
      <p className="mt-6 text-sm text-slate-500">
        Prefer email?{" "}
        <Link href="mailto:hello@permitwave.com" className="underline">
          hello@permitwave.com
        </Link>
      </p>
    </main>
  );
